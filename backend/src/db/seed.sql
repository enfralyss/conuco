...
VALUES
  ('usr-default', 'Leonardo (Productor)', 'admin@lab.com', '<HASH_ADMIN123>', 'USUARIO')
ON CONFLICT
(email) DO NOTHING;

-- ── 2. Lotes de cultivo ───────────────────────────────────────────────────────
INSERT INTO lotes
  (id, usuario_id, cultivo, etapa, area_ha, ubicacion, fecha_siembra, salud, imagen, temp_actual, hum_actual, ph_actual)
VALUES
  ('Lote-001', 'usr-default', 'Maíz Amarillo', 'Siembra Tardía', 2.40, 'Sector Norte, Parcela A', '2026-02-10', 'optima', '🌽', 26.3, 68.5, 6.4),
  ('Lote-002', 'usr-default', 'Habichuelas Rojas', 'Desarrollo Vegetativo', 1.80, 'Sector Sur, Parcela B', '2026-01-25', 'advertencia', '🫘', 29.7, 43.2, 6.8),
  ('Lote-003', 'usr-default', 'Plátano Barahonero', 'Floración', 3.10, 'Sector Este, Parcela C', '2025-11-05', 'optima', '🍌', 27.1, 71.0, 6.2),
  ('Lote-004', 'usr-default', 'Yuca Blanca', 'Engorde', 0.90, 'Sector Oeste, Parcela D', '2025-12-18', 'critica', '🌿', 33.5, 28.0, 7.8)
ON CONFLICT
(id) DO NOTHING;
...
INSERT INTO lecturas_sensores
  (sensor_id, valor, unidad, timestamp)
VALUES
  -- Temperatura (ESP32-A1)
  ('ESP32-A1', 25.1, '°C', NOW() - INTERVAL
'50 minutes'),
('ESP32-A1', 25.4, '°C', NOW
() - INTERVAL '45 minutes'),
('ESP32-A1', 25.8, '°C', NOW
...
() - INTERVAL '5 minutes'),
-- pH (ESP32-A3)
('ESP32-A3', 6.50, 'pH', NOW
() - INTERVAL '50 minutes'),
('ESP32-A3', 6.48, 'pH', NOW
() - INTERVAL '45 minutes'),
('ESP32-A3', 6.52, 'pH', NOW
() - INTERVAL '40 minutes'),
('ESP32-A3', 6.45, 'pH', NOW
() - INTERVAL '35 minutes'),
('ESP32-A3', 6.47, 'pH', NOW
() - INTERVAL '30 minutes'),
('ESP32-A3', 6.43, 'pH', NOW
() - INTERVAL '25 minutes'),
('ESP32-A3', 6.40, 'pH', NOW
() - INTERVAL '20 minutes'),
('ESP32-A3', 6.38, 'pH', NOW
() - INTERVAL '15 minutes'),
('ESP32-A3', 6.42, 'pH', NOW
() - INTERVAL '10 minutes'),
('ESP32-A3', 6.44, 'pH', NOW
() - INTERVAL '5 minutes');
...
() - INTERVAL '11 minutes'),
('ESP32-A3', 'Lote-001', 'ph',          'advertencia', 'pH elevado: 7.1',              TRUE,  NOW
() - INTERVAL '6 minutes'),
('ESP32-A3', 'Lote-001', 'ph',          'critica',     'pH muy bajo: 4.9',             FALSE, NOW
() - INTERVAL '2 minutes');
